...
eos_delaunay::eos_delaunay(string EoS_table_file)
{
	...
	cout << "  --> check minima and maxima:" << endl
		<< setw(15) << left << "       - e: "
		<< setw(10) << left << emin << "   "
		<< setw(10) << left << emax << " [MeV/fm^3]\n"
		<< setw(15) << left << "       - B: "
		<< setw(10) << left << bmin << "   "
		<< setw(10) << left << bmax << " [1/fm^3]\n"
		<< setw(15) << left << "       - S: "
		<< setw(10) << left << smin << "   "
		<< setw(10) << left << smax << " [1/fm^3]\n"
		<< setw(15) << left << "       - Q: "
		<< setw(10) << left << qmin << "   "
		<< setw(10) << left << qmax << " [1/fm^3]" << endl;
	...
	Stopwatch sw_kdtree;
	sw_kdtree.Start();
	cout << "  --> setting up kd-trees: " << std::flush;
	...
	sw_kdtree.Stop();
	cout << "finished in " << sw_kdtree.printTime() << " seconds!\n";
